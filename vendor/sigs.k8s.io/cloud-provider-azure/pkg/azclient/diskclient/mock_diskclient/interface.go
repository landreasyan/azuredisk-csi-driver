...
// BeginGrantAccess mocks base method.
func (m *MockInterface) BeginGrantAccess(ctx context.Context, resourceGroupName, diskName string, parameters armcompute.GrantAccessData) (*armcompute.DisksClientGrantAccessResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "BeginGrantAccess", ctx, resourceGroupName, diskName, parameters)
	ret0, _ := ret[0].(*armcompute.DisksClientGrantAccessResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// BeginGrantAccess indicates an expected call of BeginGrantAccess.
func (mr *MockInterfaceMockRecorder) BeginGrantAccess(ctx, resourceGroupName, diskName, parameters interface{}) *MockInterfaceBeginGrantAccessCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "BeginGrantAccess", reflect.TypeOf((*MockInterface)(nil).BeginGrantAccess), ctx, resourceGroupName, diskName, parameters)
	return &MockInterfaceBeginGrantAccessCall{Call: call}
}

// MockInterfaceBeginGrantAccessCall wrap *gomock.Call
type MockInterfaceBeginGrantAccessCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockInterfaceBeginGrantAccessCall) Return(result *armcompute.DisksClientGrantAccessResponse, err error) *MockInterfaceBeginGrantAccessCall {
	c.Call = c.Call.Return(result, err)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockInterfaceBeginGrantAccessCall) Do(f func(context.Context, string, string, armcompute.GrantAccessData) (*armcompute.DisksClientGrantAccessResponse, error)) *MockInterfaceBeginGrantAccessCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockInterfaceBeginGrantAccessCall) DoAndReturn(f func(context.Context, string, string, armcompute.GrantAccessData) (*armcompute.DisksClientGrantAccessResponse, error)) *MockInterfaceBeginGrantAccessCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
